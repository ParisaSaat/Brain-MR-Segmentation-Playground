...
mkdir -p $root_path/philips/masks_wgc
#mkdir -p $root_path/siemens/images
mkdir -p $root_path/siemens/masks_wgc
#mkdir -p $root_path/ge/images
mkdir -p $root_path/ge/masks_wgc


#cp $images_path/*_philips_* $root_path/philips/images
cp $masks_path/*_philips_* $root_path/philips/masks_wgc
#cp $images_path/*_siemens_* $root_path/siemens/images
cp $masks_path/*_siemens_* $root_path/siemens/masks_wgc
#cp $images_path/*_ge_* $root_path/ge/images
cp $masks_path/*_ge_* $root_path/ge/masks_wgc
